export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Nebula X",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Nebula X foi baixada. Você gostaria de instalá-la e reiniciar?",
