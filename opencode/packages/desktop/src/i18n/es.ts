export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Nebula X",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Nebula X. ¿Quieres instalarla y reiniciar?",
