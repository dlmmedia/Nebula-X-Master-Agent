export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Nebula X",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Nebula X er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'nebula-x'-kommandoen.",
