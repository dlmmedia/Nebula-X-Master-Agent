...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at dlmworld.com",
  ...
  "Nebula X auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Nebula X auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Nebula X uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Nebula X from reading sensitive files",
  "Use {highlight}nebula-x run{/highlight} for non-interactive scripting",
  "Use {highlight}nebula-x --continue{/highlight} to resume the last session",
  "Use {highlight}nebula-x run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}nebula-x serve{/highlight} for headless API access to Nebula X",
  "Use {highlight}nebula-x run --attach{/highlight} to connect to a running server",
  "Run {highlight}nebula-x upgrade{/highlight} to update to the latest version",
  "Run {highlight}nebula-x auth list{/highlight} to see all configured providers",
  "Run {highlight}nebula-x agent create{/highlight} for guided agent creation",
  "Use {highlight}/nebula-x{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}nebula-x github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/nebula-x fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}nebula-x debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/nebula-x{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Nebula X Zen for curated, tested models",
