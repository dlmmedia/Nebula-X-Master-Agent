...
export const dict = {
  ...
  "notFound.title": "Introuvable | Nebula X",
  ...
  "home.title": "Nebula X | L'agent de code IA open source",

  "temp.title": "Nebula X | Agent de code IA conçu pour le terminal",
  "temp.hero.title": "L'agent de code IA conçu pour le terminal",
  "temp.zen": "Nebula X Zen",
  ...
  "temp.feature.zen.afterLink": "fournie par Nebula X",
  ...
  "temp.screenshot.caption": "Nebula X TUI avec le thème tokyonight",
  "temp.screenshot.alt": "Nebula X TUI avec le thème tokyonight",
  ...
  "home.what.title": "Qu'est-ce que Nebula X ?",
  "home.what.body":
    "Nebula X est un agent open source qui vous aide à écrire du code dans votre terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Avec plus de <strong>{{stars}}</strong> étoiles sur GitHub, <strong>{{contributors}}</strong> contributeurs et plus de <strong>{{commits}}</strong> commits, Nebula X est utilisé et approuvé par plus de <strong>{{monthlyUsers}}</strong> développeurs chaque mois.",
  ...
  "home.privacy.body":
    "Nebula X ne stocke ni votre code ni vos données de contexte, afin de pouvoir fonctionner dans des environnements sensibles à la confidentialité.",
  "home.privacy.learnMore": "En savoir plus sur",
  "home.privacy.link": "la confidentialité",

  "home.faq.q1": "Qu'est-ce que Nebula X ?",
  "home.faq.a1":
    "Nebula X est un agent open source qui vous aide à écrire et exécuter du code avec n'importe quel modèle d'IA. Il est disponible en interface terminal, application desktop ou extension IDE.",
  "home.faq.q2": "Comment utiliser Nebula X ?",
  "home.faq.a2.before": "Le moyen le plus simple de commencer est de lire l'",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Ai-je besoin d'abonnements IA supplémentaires pour utiliser Nebula X ?",
  "home.faq.a3.p1":
    "Pas forcément : Nebula X propose des modèles gratuits que vous pouvez utiliser sans créer de compte.",
  "home.faq.a3.p2.beforeZen": "En plus, vous pouvez utiliser des modèles populaires pour le code en créant un compte",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Nous encourageons l'utilisation de Zen, mais Nebula X fonctionne aussi avec les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Vous pouvez même connecter vos",
  "home.faq.a3.p4.localLink": "modèles locaux",
  "home.faq.q4": "Puis-je utiliser mes abonnements IA existants avec Nebula X ?",
  "home.faq.a4.p1":
    "Oui, Nebula X prend en charge les abonnements des principaux fournisseurs. Vous pouvez utiliser Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Puis-je utiliser Nebula X uniquement dans le terminal ?",
  "home.faq.a5.beforeDesktop": "Plus maintenant ! Nebula X est désormais disponible en application pour",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "et",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Combien coûte Nebula X ?",
  "home.faq.a6":
    "Nebula X est 100% gratuit. Il inclut aussi des modèles gratuits. Des coûts supplémentaires peuvent s'appliquer si vous connectez un autre fournisseur.",
  ...
  "home.faq.q8": "Nebula X est-il open source ?",
  "home.faq.a8.p1": "Oui, Nebula X est entièrement open source. Le code source est public sur",
  ...
  "home.zenCta.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que Nebula X a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",
  "home.zenCta.link": "En savoir plus sur Zen",

  "zen.title": "Nebula X Zen | Un ensemble sélectionné de modèles fiables et optimisés pour les agents de code",
  "zen.hero.title": "Modèles fiables et optimisés pour les agents de code",
  "zen.hero.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que Nebula X a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",

  "zen.faq.q1": "Qu'est-ce que Nebula X Zen ?",
  "zen.faq.a1":
    "Zen est un ensemble sélectionné de modèles d'IA testés et benchmarkés pour les agents de code, créé par l'équipe derrière Nebula X.",
  ...
  "zen.faq.a3":
    "Zen n'est pas à but lucratif. Zen vous facture au prix coûtant des fournisseurs de modèles. Plus Zen est utilisé, plus Nebula X peut négocier de meilleurs tarifs et vous les répercuter.",
  ...
  "zen.faq.a4.p3":
    "Pour couvrir les coûts, Nebula X ajoute uniquement de petits frais de traitement de paiement de 1,23 $ par recharge de 20 $.",
  ...
  "zen.faq.a8":
    "Zen fonctionne très bien avec Nebula X, mais vous pouvez utiliser Zen avec n'importe quel agent. Suivez les instructions de configuration dans votre agent préféré.",
  ...
  "zen.problem.subtitle":
    "Nous résolvons ce problème pour tout le monde, pas seulement pour les utilisateurs de Nebula X.",
  ...
  "zen.how.body":
    "Bien que nous vous suggérions d'utiliser Zen avec Nebula X, vous pouvez utiliser Zen avec n'importe quel agent.",
  ...
  "black.meta.title": "Nebula X Black | Accédez aux meilleurs modèles de code au monde",
  "black.meta.description": "Accédez à Claude, GPT, Gemini et plus avec les forfaits d'abonnement Nebula X Black.",
  "black.hero.title": "Accédez aux meilleurs modèles de code au monde",
  "black.hero.subtitle": "Y compris Claude, GPT, Gemini et plus",
  "black.title": "Nebula X Black | Tarification",
  ...
  "black.workspace.title": "Nebula X Black | Sélectionner un espace de travail",
  "black.workspace.selectPlan": "Sélectionnez un espace de travail pour ce forfait",
  "black.workspace.name": "Espace de travail {{n}}",
  "black.subscribe.title": "S'abonner à Nebula X Black",
  ...
  "black.subscribe.success.title": "Vous êtes sur la liste d'attente Nebula X Black",
  "black.subscribe.success.subscriptionPlan": "Forfait d'abonnement",
  "black.subscribe.success.planName": "Nebula X Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilisez Zen avec n'importe quel agent de code et continuez à utiliser d'autres fournisseurs avec Nebula X quand vous le souhaitez.",
  ...
  "workspace.newUser.step.login.after": "et sélectionnez Nebula X",
  "workspace.newUser.step.pasteKey": "Collez votre clé API",
  "workspace.newUser.step.models.before": "Démarrez Nebula X et exécutez",
  ...
  "workspace.keys.subtitle": "Gérez vos clés API pour accéder aux services Nebula X.",
  "workspace.keys.create": "Créer une clé API",
  "workspace.keys.placeholder": "Entrez le nom de la clé",
  "workspace.keys.empty": "Créer une clé API Nebula X Gateway",
  ...
  "workspace.black.subscription.message": "Vous êtes abonné à Nebula X Black pour {{plan}} $ par mois.",
  ...
  "workspace.black.waitlist.joined":
    "Vous êtes sur la liste d'attente pour le forfait Nebula X Black à {{plan}} $ par mois.",
  "workspace.black.waitlist.ready":
    "Nous sommes prêts à vous inscrire au forfait Nebula X Black à {{plan}} $ par mois.",
  ...
  "download.title": "Nebula X | Téléchargement",
  "download.meta.description": "Téléchargez Nebula X pour macOS, Windows et Linux",
  "download.hero.title": "Télécharger Nebula X",
  "download.hero.subtitle": "Disponible en bêta pour macOS, Windows et Linux",
  "download.hero.button": "Télécharger pour {{os}}",
  "download.section.terminal": "Nebula X Terminal",
  "download.section.desktop": "Nebula X Desktop (Bêta)",
  "download.section.extensions": "Extensions Nebula X",
  "download.section.integrations": "Intégrations Nebula X",
  ...
  "download.faq.a3.beforeLocal":
    "Pas forcément, mais probablement. Vous aurez besoin d'un abonnement IA si vous voulez connecter Nebula X à un fournisseur payant, mais vous pouvez travailler avec des",
  ...
  "download.faq.a3.afterZen":
    ", Nebula X fonctionne avec tous les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Nebula X est 100% gratuit à utiliser.",
  "download.faq.a5.p2.beforeZen":
    "Les coûts supplémentaires viendront de votre abonnement à un fournisseur de modèle. Même si Nebula X fonctionne avec n'importe quel fournisseur, nous recommandons d'utiliser",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Vos données et informations ne sont stockées que lorsque vous créez des liens partageables dans Nebula X.",
  "download.faq.a6.p2.beforeShare": "En savoir plus sur",
  "download.faq.a6.shareLink": "les pages de partage",

  "enterprise.title": "Nebula X | Solutions entreprise pour votre organisation",
  "enterprise.meta.description": "Contactez Nebula X pour des solutions entreprise",
  "enterprise.hero.title": "Votre code vous appartient",
  "enterprise.hero.body1":
    "Nebula X fonctionne de manière sécurisée au sein de votre organisation, sans stocker de données ni de contexte, et sans restrictions de licence ni revendications de propriété. Démarrez un essai avec votre équipe, puis déployez-le dans votre organisation en l'intégrant à votre SSO et à votre passerelle IA interne.",
  ...
  "enterprise.faq.q1": "Qu'est-ce que Nebula X Enterprise ?",
  "enterprise.faq.a1":
    "Nebula X Enterprise s'adresse aux organisations qui veulent s'assurer que leur code et leurs données ne quittent jamais leur infrastructure. Cela est possible grâce à une configuration centralisée qui s'intègre à votre SSO et à votre passerelle IA interne.",
  "enterprise.faq.q2": "Comment démarrer avec Nebula X Enterprise ?",
  "enterprise.faq.a2":
    "Commencez simplement par un essai interne avec votre équipe. Par défaut, Nebula X ne stocke pas votre code ni vos données de contexte, ce qui facilite la prise en main. Ensuite, contactez-nous pour discuter des tarifs et des options de mise en œuvre.",
  ...
  "enterprise.faq.q4": "Mes données sont-elles sécurisées avec Nebula X Enterprise ?",
  "enterprise.faq.a4":
    "Oui. Nebula X ne stocke pas votre code ni vos données de contexte. Tout le traitement se fait localement ou via des appels API directs vers votre fournisseur d'IA. Avec une configuration centralisée et une intégration SSO, vos données restent sécurisées au sein de l'infrastructure de votre organisation.",

  "brand.title": "Nebula X | Marque",
  "brand.meta.description": "Guide de marque Nebula X",
  "brand.heading": "Guide de marque",
  "brand.subtitle": "Ressources et éléments pour vous aider à travailler avec la marque Nebula X.",
  "brand.downloadAll": "Télécharger tous les assets",

  "changelog.title": "Nebula X | Changelog",
  "changelog.meta.description": "Notes de version et changelog d'Nebula X",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nouvelles mises à jour et améliorations pour Nebula X",
